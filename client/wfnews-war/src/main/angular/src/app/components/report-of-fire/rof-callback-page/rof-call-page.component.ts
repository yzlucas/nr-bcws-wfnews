...
export class RofCallPage extends RoFPage {
  ...
  callInfo = [
    {title: 'Location', info: 'Where is the fire? How far up the hillside? Closest intersection?'},
    {title: 'Size', info: 'Metres? Hectares? Size of a house? Size of a football field?'},
    {title: 'Rate of spread', info: 'How quickly is the fire spreading?'},
    {title: 'Fuel', info: 'What is burning? Grass, bushes, trees?'},
    {title: 'Smoke/flames', info: 'What colour is the smoke? Are the flames visible?'},
    {title: 'Threat', info: 'Are there any people or buildings at risk?'},
    {title: 'Action', info: 'Is anyone fighting the fire?'},
    {title: 'Campfires', info: 'Can you tell if it is wood burning or is it a propane campfire?'},
    ];

    public constructor(private appConfig: AppConfigService, private commonUtilityService: CommonUtilityService) {
      super();
    }
